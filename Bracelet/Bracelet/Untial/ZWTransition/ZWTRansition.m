...
- (void)pushAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    UIViewController<ZWTransitionProtocol> * fromVC = (UIViewController <ZWTransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    UIViewController<ZWTransitionProtocol> * toVC = (UIViewController <ZWTransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //from和to的两个视图
    ...
    UIView *fromCellView = [fromVC targetTransitionView];    UIView *toCellView = [toVC targetTransitionView];
